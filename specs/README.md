...
- [write-project](features/ralph/write-project/spec.md) — Defines the format of ralph project files — the item array, index, and key — and the rules for writing them.
