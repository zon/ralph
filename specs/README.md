...
- [setup](ralph/setup.md) — Confirms that git, the GitHub CLI, and OpenCode are ready to run Ralph, and prepares a Kubernetes namespace for remote Argo Workflow execution when a namespace is targeted via flag or config.
