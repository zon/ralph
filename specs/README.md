...
- [setup](ralph/setup.md) — One-shot setup of all Kubernetes credentials required for Ralph remote execution on Argo Workflows, accepting a GitHub App key or a personal access token.
