...
4. **Draft and write the file** following the format and guidelines in `docs/formats/project.md`.

5. **Validate** the file using the command in `docs/formats/project.md`.
