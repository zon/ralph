...
Create a well-formed flow file in `./specs/` based on the user's description of the feature or process.
...
3. **Determine the file path.** Check the existing `specs/` structure and place the flow at `./specs/<component>/<feature>/flow.md`.
...
6. **Write the file** to `./specs/<component>/<feature>/flow.md`.
