...
What a project file should contain beyond that — the conventional shape of an item and the fields a well-formed project carries — is defined outside ralph. See [Project Format](specs/project.md) in the installed spec documents.
