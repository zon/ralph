...
The guide covers the markdown documents the app itself displays: the configuration reference behind `ralph help config` and the project file guide behind `ralph help project`. Those are embedded from [../internal/config/config.md](../internal/config/config.md) and [../internal/projectfile/project.md](../internal/projectfile/project.md). It does not cover repository guides like [testing.md](testing.md) or prompt instructions fed to agents.
