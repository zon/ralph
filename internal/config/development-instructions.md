...
2. Write tests covering the new functionality BEFORE or ALONGSIDE implementation
...
4. Update the requirement in the project YAML file to 'passing: true' ONLY if:
   - The requirement is fully implemented and complete
   - All tests are passing
5. If you are COMPLETELY BLOCKED and cannot make any progress:
