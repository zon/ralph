...
// opening, exactly like `ralph loop --mode local`. The injected runner wraps
// the same loop orchestration the local-mode path wires, fed with the same
// fakes the local-mode tests use.
