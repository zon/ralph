...
type Cmd struct {
	...
	Setup      SetupCmd      `cmd:"" help:"Confirm git, gh, and OpenCode are ready to run Ralph. Prepare a Kubernetes namespace only when one is targeted, confirming kubectl and argo are installed first"`
